...
insertIntoFlat.run({
  ...
  inverter_qpigs_add_sbu_priority_version: inverterData?.qpigs?.add_sbu_priority_version ? 1 : 0,
  inverter_qpigs_configuration_status: inverterData?.qpigs?.configuration_status ? 1 : 0,
  inverter_qpigs_scc_firmware_version: inverterData?.qpigs?.scc_firmware_version ? 1 : 0,
  inverter_qpigs_load_status: inverterData?.qpigs?.load_status ? 1 : 0,
  inverter_qpigs_battery_voltage_to_steady_while_charging: inverterData?.qpigs?.battery_voltage_to_steady_while_charging ? 1 : 0,
  inverter_qpigs_charging_status: inverterData?.qpigs?.charging_status ? 1 : 0,
  inverter_qpigs_charging_status_scc_1: inverterData?.qpigs?.charging_status_scc_1 ? 1 : 0,
  inverter_qpigs_charging_status_ac: inverterData?.qpigs?.charging_status_ac ? 1 : 0,
  ...
  inverter_qpigs_flag_for_charging_to_flating_mode: inverterData?.qpigs?.flag_for_charging_to_flating_mode ? 1 : 0,
  inverter_qpigs_switch_on: inverterData?.qpigs?.switch_on ? 1 : 0,
  inverter_qpigs_device_status_2_reserved: inverterData?.qpigs?.device_status_2_reserved ? 1 : 0,
  ...
  inverter_qpiws_reserved1: inverterData?.qpiws?.reserved1 ? 1 : 0,
  inverter_qpiws_inverter_fault: inverterData?.qpiws?.inverter_fault ? 1 : 0,
  inverter_qpiws_bus_over: inverterData?.qpiws?.bus_over ? 1 : 0,
  inverter_qpiws_bus_under: inverterData?.qpiws?.bus_under ? 1 : 0,
  inverter_qpiws_bus_soft_fail: inverterData?.qpiws?.bus_soft_fail ? 1 : 0,
  inverter_qpiws_line_fail: inverterData?.qpiws?.line_fail ? 1 : 0,
  inverter_qpiws_opvshort: inverterData?.qpiws?.opvshort ? 1 : 0,
  inverter_qpiws_inverter_voltage_too_low: inverterData?.qpiws?.inverter_voltage_too_low ? 1 : 0,
  inverter_qpiws_inverter_voltage_too_high: inverterData?.qpiws?.inverter_voltage_too_high ? 1 : 0,
  inverter_qpiws_over_temperature: inverterData?.qpiws?.over_temperature ? 1 : 0,
  inverter_qpiws_fan_locked: inverterData?.qpiws?.fan_locked ? 1 : 0,
  inverter_qpiws_battery_voltage_high: inverterData?.qpiws?.battery_voltage_high ? 1 : 0,
  inverter_qpiws_battery_low_alarm: inverterData?.qpiws?.battery_low_alarm ? 1 : 0,
  inverter_qpiws_reserved_overcharge: inverterData?.qpiws?.reserved_overcharge ? 1 : 0,
  inverter_qpiws_battery_under_shutdown: inverterData?.qpiws?.battery_under_shutdown ? 1 : 0,
  inverter_qpiws_reserved_battery_derating: inverterData?.qpiws?.reserved_battery_derating ? 1 : 0,
  inverter_qpiws_over_load: inverterData?.qpiws?.over_load ? 1 : 0,
  inverter_qpiws_eeprom_fault: inverterData?.qpiws?.eeprom_fault ? 1 : 0,
  inverter_qpiws_inverter_over_current: inverterData?.qpiws?.inverter_over_current ? 1 : 0,
  inverter_qpiws_inverter_soft_fail: inverterData?.qpiws?.inverter_soft_fail ? 1 : 0,
  inverter_qpiws_self_test_fail: inverterData?.qpiws?.self_test_fail ? 1 : 0,
  inverter_qpiws_op_dv_voltage_over: inverterData?.qpiws?.op_dv_voltage_over ? 1 : 0,
  inverter_qpiws_bat_open: inverterData?.qpiws?.bat_open ? 1 : 0,
  inverter_qpiws_current_sensor_fail: inverterData?.qpiws?.current_sensor_fail ? 1 : 0,
  inverter_qpiws_battery_short: inverterData?.qpiws?.battery_short ? 1 : 0,
  inverter_qpiws_power_limit: inverterData?.qpiws?.power_limit ? 1 : 0,
  inverter_qpiws_pv_voltage_high_1: inverterData?.qpiws?.pv_voltage_high_1 ? 1 : 0,
  inverter_qpiws_mppt_overload_fault_1: inverterData?.qpiws?.mppt_overload_fault_1 ? 1 : 0,
  inverter_qpiws_mppt_overload_warning_1: inverterData?.qpiws?.mppt_overload_warning_1 ? 1 : 0,
  inverter_qpiws_battery_too_low_to_charge_1: inverterData?.qpiws?.battery_too_low_to_charge_1 ? 1 : 0,
  inverter_qpiws_pv_voltage_high_2: inverterData?.qpiws?.pv_voltage_high_2 ? 1 : 0,
  inverter_qpiws_mppt_overload_fault_2: inverterData?.qpiws?.mppt_overload_fault_2 ? 1 : 0,
  inverter_qpiws_mppt_overload_warning_2: inverterData?.qpiws?.mppt_overload_warning_2 ? 1 : 0,
  inverter_qpiws_battery_too_low_to_charge_2: inverterData?.qpiws?.battery_too_low_to_charge_2 ? 1 : 0,
  inverter_qpiws_unknown1: inverterData?.qpiws?.unknown1 ? 1 : 0,
  inverter_qpiws_unknown2: inverterData?.qpiws?.unknown2 ? 1 : 0,
  ...
  battery_bms_cell_status_0: batteryData?.cell_status?.[0] ? 1 : 0,
  battery_bms_cell_status_1: batteryData?.cell_status?.[1] ? 1 : 0,
  battery_bms_cell_status_2: batteryData?.cell_status?.[2] ? 1 : 0,
  battery_bms_cell_status_3: batteryData?.cell_status?.[3] ? 1 : 0,
  battery_bms_cell_status_4: batteryData?.cell_status?.[4] ? 1 : 0,
  battery_bms_cell_status_5: batteryData?.cell_status?.[5] ? 1 : 0,
  battery_bms_cell_status_6: batteryData?.cell_status?.[6] ? 1 : 0,
  battery_bms_cell_status_7: batteryData?.cell_status?.[7] ? 1 : 0,
  battery_bms_cell_status_8: batteryData?.cell_status?.[8] ? 1 : 0,
  battery_bms_cell_status_9: batteryData?.cell_status?.[9] ? 1 : 0,
  battery_bms_cell_status_10: batteryData?.cell_status?.[10] ? 1 : 0,
  battery_bms_cell_status_11: batteryData?.cell_status?.[11] ? 1 : 0,
  battery_bms_cell_status_12: batteryData?.cell_status?.[12] ? 1 : 0,
  battery_bms_cell_status_13: batteryData?.cell_status?.[13] ? 1 : 0,
  battery_bms_cell_status_14: batteryData?.cell_status?.[14] ? 1 : 0,
  battery_bms_cell_status_15: batteryData?.cell_status?.[15] ? 1 : 0,
  battery_bms_cell_status_16: batteryData?.cell_status?.[16] ? 1 : 0,
  battery_bms_cell_status_17: batteryData?.cell_status?.[17] ? 1 : 0,
  battery_bms_cell_status_18: batteryData?.cell_status?.[18] ? 1 : 0,
  battery_bms_cell_status_19: batteryData?.cell_status?.[19] ? 1 : 0,
  battery_bms_cell_status_20: batteryData?.cell_status?.[20] ? 1 : 0,
  battery_bms_cell_status_21: batteryData?.cell_status?.[21] ? 1 : 0,
  battery_bms_cell_status_22: batteryData?.cell_status?.[22] ? 1 : 0,
  battery_bms_cell_status_23: batteryData?.cell_status?.[23] ? 1 : 0,
  battery_bms_cell_status_24: batteryData?.cell_status?.[24] ? 1 : 0,
  battery_bms_cell_status_25: batteryData?.cell_status?.[25] ? 1 : 0,
  battery_bms_cell_status_26: batteryData?.cell_status?.[26] ? 1 : 0,
  battery_bms_cell_status_27: batteryData?.cell_status?.[27] ? 1 : 0,
  battery_bms_cell_status_28: batteryData?.cell_status?.[28] ? 1 : 0,
  battery_bms_cell_status_29: batteryData?.cell_status?.[29] ? 1 : 0,
  battery_bms_cell_status_30: batteryData?.cell_status?.[30] ? 1 : 0,
  battery_bms_cell_status_31: batteryData?.cell_status?.[31] ? 1 : 0,
  battery_bms_cell_wire_status_0: batteryData?.cell_wire_resistance_status?.[0] ? 1 : 0,
  battery_bms_cell_wire_status_1: batteryData?.cell_wire_resistance_status?.[1] ? 1 : 0,
  battery_bms_cell_wire_status_2: batteryData?.cell_wire_resistance_status?.[2] ? 1 : 0,
  battery_bms_cell_wire_status_3: batteryData?.cell_wire_resistance_status?.[3] ? 1 : 0,
  battery_bms_cell_wire_status_4: batteryData?.cell_wire_resistance_status?.[4] ? 1 : 0,
  battery_bms_cell_wire_status_5: batteryData?.cell_wire_resistance_status?.[5] ? 1 : 0,
  battery_bms_cell_wire_status_6: batteryData?.cell_wire_resistance_status?.[6] ? 1 : 0,
  battery_bms_cell_wire_status_7: batteryData?.cell_wire_resistance_status?.[7] ? 1 : 0,
  battery_bms_cell_wire_status_8: batteryData?.cell_wire_resistance_status?.[8] ? 1 : 0,
  battery_bms_cell_wire_status_9: batteryData?.cell_wire_resistance_status?.[9] ? 1 : 0,
  battery_bms_cell_wire_status_10: batteryData?.cell_wire_resistance_status?.[10] ? 1 : 0,
  battery_bms_cell_wire_status_11: batteryData?.cell_wire_resistance_status?.[11] ? 1 : 0,
  battery_bms_cell_wire_status_12: batteryData?.cell_wire_resistance_status?.[12] ? 1 : 0,
  battery_bms_cell_wire_status_13: batteryData?.cell_wire_resistance_status?.[13] ? 1 : 0,
  battery_bms_cell_wire_status_14: batteryData?.cell_wire_resistance_status?.[14] ? 1 : 0,
  battery_bms_cell_wire_status_15: batteryData?.cell_wire_resistance_status?.[15] ? 1 : 0,
  battery_bms_cell_wire_status_16: batteryData?.cell_wire_resistance_status?.[16] ? 1 : 0,
  battery_bms_cell_wire_status_17: batteryData?.cell_wire_resistance_status?.[17] ? 1 : 0,
  battery_bms_cell_wire_status_18: batteryData?.cell_wire_resistance_status?.[18] ? 1 : 0,
  battery_bms_cell_wire_status_19: batteryData?.cell_wire_resistance_status?.[19] ? 1 : 0,
  battery_bms_cell_wire_status_20: batteryData?.cell_wire_resistance_status?.[20] ? 1 : 0,
  battery_bms_cell_wire_status_21: batteryData?.cell_wire_resistance_status?.[21] ? 1 : 0,
  battery_bms_cell_wire_status_22: batteryData?.cell_wire_resistance_status?.[22] ? 1 : 0,
  battery_bms_cell_wire_status_23: batteryData?.cell_wire_resistance_status?.[23] ? 1 : 0,
  battery_bms_cell_wire_status_24: batteryData?.cell_wire_resistance_status?.[24] ? 1 : 0,
  battery_bms_cell_wire_status_25: batteryData?.cell_wire_resistance_status?.[25] ? 1 : 0,
  battery_bms_cell_wire_status_26: batteryData?.cell_wire_resistance_status?.[26] ? 1 : 0,
  battery_bms_cell_wire_status_27: batteryData?.cell_wire_resistance_status?.[27] ? 1 : 0,
  battery_bms_cell_wire_status_28: batteryData?.cell_wire_resistance_status?.[28] ? 1 : 0,
  battery_bms_cell_wire_status_29: batteryData?.cell_wire_resistance_status?.[29] ? 1 : 0,
  battery_bms_cell_wire_status_30: batteryData?.cell_wire_resistance_status?.[30] ? 1 : 0,
  battery_bms_cell_wire_status_31: batteryData?.cell_wire_resistance_status?.[31] ? 1 : 0,
  battery_bms_alarms_resistence_of_the_balancing_wire_too_large: batteryData?.alarms?.[0]?.resistence_of_the_balancing_wire_too_large ? 1 : 0,
  battery_bms_alarms_mos_overtemperature_protection: batteryData?.alarms?.[1]?.MOS_overtemperature_protection ? 1 : 0,
  battery_bms_alarms_the_number_of_cells_does_not_match_the_set_value: batteryData?.alarms?.[2]?.the_number_of_cells_does_not_match_the_set_value ? 1 : 0,
  battery_bms_alarms_current_sensor_abnormality: batteryData?.alarms?.[3]?.current_sensor_abnormality ? 1 : 0,
  battery_bms_alarms_single_unit_overvoltage_protection: batteryData?.alarms?.[4]?.single_unit_overvoltage_protection ? 1 : 0,
  battery_bms_alarms_battery_overvoltage_protection: batteryData?.alarms?.[5]?.battery_overvoltage_protection ? 1 : 0,
  battery_bms_alarms_charging_overcurrent_protection: batteryData?.alarms?.[6]?.charging_overcurrent_protection ? 1 : 0,
  battery_bms_alarms_charging_short_circuit_protection: batteryData?.alarms?.[7]?.charging_short_circuit_protection ? 1 : 0,
  battery_bms_alarms_charging_over_temperature_protection: batteryData?.alarms?.[8]?.charging_over_temperature_protection ? 1 : 0,
  battery_bms_alarms_charging_low_temperature_protection: batteryData?.alarms?.[9]?.charging_low_temperature_protection ? 1 : 0,
  battery_bms_alarms_internal_communication_abnormality: batteryData?.alarms?.[10]?.internal_communication_abnormality ? 1 : 0,
  battery_bms_alarms_single_unit_undervoltage_protection: batteryData?.alarms?.[11]?.single_unit_undervoltage_protection ? 1 : 0,
  battery_bms_alarms_battery_undervoltage_protection: batteryData?.alarms?.[12]?.battery_undervoltage_protection ? 1 : 0,
  battery_bms_alarms_discharge_overcurrent_protection: batteryData?.alarms?.[13]?.discharge_overcurrent_protection ? 1 : 0,
  battery_bms_alarms_discharge_short_circuit_protection: batteryData?.alarms?.[14]?.discharge_short_circuit_protection ? 1 : 0,
  battery_bms_alarms_discharge_over_temperature_protection: batteryData?.alarms?.[15]?.discharge_over_temperature_protection ? 1 : 0,
  battery_bms_alarms_charging_anomaly: batteryData?.alarms?.[16]?.charging_anomality ? 1 : 0,
  battery_bms_alarms_discharge_anomaly: batteryData?.alarms?.[17]?.discharge_anomality ? 1 : 0,
  battery_bms_alarms_gps_disconnected: batteryData?.alarms?.[18]?.GPS_disconnected ? 1 : 0,
  battery_bms_alarms_please_change_the_authorization_password: batteryData?.alarms?.[19]?.please_change_the_authorization_password ? 1 : 0,
  battery_bms_alarms_discharge_on_failure: batteryData?.alarms?.[20]?.discharge_on_failure ? 1 : 0,
  battery_bms_alarms_battery_over_temperature: batteryData?.alarms?.[21]?.battery_over_temperature ? 1 : 0,
  battery_bms_alarms_temperature_sensor_anomaly: batteryData?.alarms?.[22]?.temperature_sensor_anomaly ? 1 : 0,
  battery_bms_alarms_parallel_module_failure: batteryData?.alarms?.[23]?.parallel_module_failure ? 1 : 0,
  battery_bms_alarms_unknown_1: batteryData?.alarms?.[24]?.unknown_1 ? 1 : 0,
  battery_bms_alarms_unknown_2: batteryData?.alarms?.[25]?.unknown_2 ? 1 : 0,
  battery_bms_alarms_unknown_3: batteryData?.alarms?.[26]?.unknown_3 ? 1 : 0,
  battery_bms_alarms_unknown_4: batteryData?.alarms?.[27]?.unknown_4 ? 1 : 0,
  battery_bms_alarms_unknown_5: batteryData?.alarms?.[28]?.unknown_5 ? 1 : 0,
  battery_bms_alarms_unknown_6: batteryData?.alarms?.[29]?.unknown_6 ? 1 : 0,
  battery_bms_alarms_unknown_7: batteryData?.alarms?.[30]?.unknown_7 ? 1 : 0,
  battery_bms_alarms_unknown_8: batteryData?.alarms?.[31]?.unknown_8 ? 1 : 0,
  battery_bms_temperature_sensor_status_mos_temperature_sensor: batteryData?.temperature_sensor_status?.[0]?.MOS_temperature_sensor ? 1 : 0,
  battery_bms_temperature_sensor_status_battery_temperature_sensor_1: batteryData?.temperature_sensor_status?.[1]?.battery_temperature_sensor_1 ? 1 : 0,
  battery_bms_temperature_sensor_status_battery_temperature_sensor_2: batteryData?.temperature_sensor_status?.[2]?.battery_temperature_sensor_2 ? 1 : 0,
  battery_bms_temperature_sensor_status_battery_temperature_sensor_3: batteryData?.temperature_sensor_status?.[3]?.battery_temperature_sensor_3 ? 1 : 0,
  battery_bms_temperature_sensor_status_battery_temperature_sensor_4: batteryData?.temperature_sensor_status?.[4]?.battery_temperature_sensor_4 ? 1 : 0,
  battery_bms_temperature_sensor_status_battery_temperature_sensor_5: batteryData?.temperature_sensor_status?.[5]?.battery_temperature_sensor_5 ? 1 : 0,
  battery_bms_temperature_sensor_status_unknown1: batteryData?.temperature_sensor_status?.[6]?.unknown1 ? 1 : 0,
  battery_bms_temperature_sensor_status_unknown2: batteryData?.temperature_sensor_status?.[7]?.unknown2 ? 1 : 0,
});
